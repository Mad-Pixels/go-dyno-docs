    ...
    en: {
      ...
      themeConfig: {
        ...
        nav: [
          {
            text: "Installation",
            link: `/en/${versionsConfig.latest}/guide/installation`,
          },
          ...
          [`/en/${versionsConfig.latest}`]: [
            {
              ...
              items: [
                ...
                {
                  text: "Quick Start",
                  link: `/en/${versionsConfig.latest}/guide/quickstart`,
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "IaC",
                  link: `/en/${versionsConfig.latest}/reference/iac`,
                },
                {
                  text: "JSON",
                  link: `/en/${versionsConfig.latest}/reference/json`,
                },
                {
                  text: "CLI",
                  link: `/en/${versionsConfig.latest}/reference/cli`,
                },
                {
                  text: "API",
                  link: `/en/${versionsConfig.latest}/reference/api`,
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "Changelog",
                  link: `/en/${versionsConfig.latest}/product/changelog`,
                },
                {
                  text: "⭐ Give Us a star",
    ...
    ru: {
      ...
      themeConfig: {
        ...
        nav: [
          {
            text: "Установка",
            link: `/ru/${versionsConfig.latest}/guide/installation`,
          },
          ...
          [`/ru/${versionsConfig.latest}/`]: [
            {
              ...
              items: [
                ...
                {
                  text: "Быстрый старт",
                  link: `/ru/${versionsConfig.latest}/guide/quickstart`,
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "IaC",
                  link: `/ru/${versionsConfig.latest}/reference/iac`,
                },
                {
                  text: "JSON",
                  link: `/ru/${versionsConfig.latest}/reference/json`,
                },
                {
                  text: "CLI",
                  link: `/ru/${versionsConfig.latest}/reference/cli`,
                },
                {
                  text: "API",
                  link: `/ru/${versionsConfig.latest}/reference/api`,
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "Изменения",
                  link: `/ru/${versionsConfig.latest}/product/changelog`,
                },
                {
                  text: "⭐ Give Us a star",
                  link: `https://github.com/Mad-Pixels/go-dyno`,
  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content:
          "Generate type-safe Go code from DynamoDB schemas. Fast. Simple. Reliable.",
      },
    ],
    [
      "meta",
      {
        property: "og:title",
        content: "GoDyno: DynamoDB Schema to GoLang Code",
      },
    ],
    [
      "meta",
      {
        property: "og:image",
        content: "https://go-dyno.madpixels.io/logo.png",
      },
    ],
    ...
    [
      "meta",
      {
        ...
        content: "Generate type-safe Go code from DynamoDB schemas",
      },
    ],
    [
      "meta",
