...
::: tip Установка:
_Если вы еще не установили GoDyno, перейдите к разделу [установки](https://go-dyno.madpixels.io/en/v0.0.1-alpha/guide/installation)._
:::
...
[Полное описание JSON схемы →](../reference/schema)
